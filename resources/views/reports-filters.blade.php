<div class="row my-4">
    ...
    <div class="accordion" id="accordion">
        ...
        <div class="card">
            ...
            <div id="collapse-search" class="collapse {{$collapseShow ?? ''}}" aria-labelledby="heading-search" data-bs-parent="#accordion">
                <div class="card-body">
                    ...
                    <form method="GET" class="px-2 pt-2" action="{{route('filter-report')}}">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="form-group col-lg-9">
                                ...
                                <input value="{{ $oldRequest->taskSearch ?? ''}}" type="text" name="taskSearch" class="form-control mb-4" id="taskSearch">
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="form-group col-lg-4 mb-4">
                                ...
                                <div class="border border-2 rounded p-3">
                                    ...
                                    <input value="{{ $oldRequest->dueDateFrom ?? ''}}" type="date" name="dueDateFrom" class="form-control mb-4" id="dueDateFrom">

                                    <label for="dueDateUntil">Until</label>
                                    <input value="{{ $oldRequest->dueDateUntil ?? ''}}" type="date" name="dueDateUntil" class="form-control mb-4" id="dueDateUntil">
                                </div>
                            </div>
                                ...
                                <div>
                                    <div class="border border-2 founded p-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="searchOrder" id="inlineRadio1" value="userName" @if( isset($oldRequest) && $oldRequest->searchOrder == 'userName')
                                            {{'checked'}}
                                            @endif >
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="searchOrder" id="inlineRadio3" value="dueDate" @if( isset($oldRequest) && $oldRequest->searchOrder == 'dueDate')
                                            {{'checked'}}
                                            @endif >
